          ...
          <div className="row d-flex flex-md-row">
            ...
            <div className="col-sm-3 mb-4">
              ...
              <div className="footer-links d-flex flex-column">
                <Link to="/privacy-policy" className="text-white py-sm-2  mb-1">Privacy Policy</Link>
                <Link to="/refund-policy" className="text-white py-sm-2  mb-1">Refund Policy</Link>
                <Link to="/shipping-policy" className="text-white py-sm-2  mb-1">Shipping policy</Link>
                <Link to="/term-conditions" className="text-white py-sm-2  mb-1">Terms & Conditions</Link>
                <Link to="/blogs" className="text-white py-sm-2  mb-1">Blogs</Link>
              </div>
            </div>
